        ...
        <ScreenMain>
            ...
            <section className="w-full h-9/10">
                <section className="p-4 h-full flex items-center flex-col gap-5">
                    ...
                    <input className="p-4 border-4 rounded-lg border-zinc-600 text-2xl font-bold bg-black text-white placeholder-zinc-600 w-full" type="text" placeholder="Kamer code..." />
